...
- You will provide feedback to peers (on 10/14)
...
You will share this in class on Thursday 10/28. This will involve approximately a 5 minute presentation.
...
**Stage 3**
- Final project
  - Submission of a product (likely a rendered `.Rmd` file, but possibly something): why you chose to work on this, what you did, and what you want to do next, Due 12/7/21- _strict deadline_
  - 15 minute presentation, in class 11/30/21, please describe:
...
- **Final Product** Please submit _an HTML file_ for this assignment on Canvas. If you used a different format (other than Rmd), you may submit a relevant product (e.g., an attachment or a link to a Shiny app).
  - Please also share the product (the .Rmd version if you used R Markdown, or whatever format your final project took) on slack
